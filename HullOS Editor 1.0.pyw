...
forever
  ...
  sound f
    ...
    def __init__(self,root):
        ...
        self.root.title("HullOS Editor Vsn 1.0 Rob Miles")
        ...
        self.code_Text = Text(self.frame)
        ...
        disconnectSerialButton = Button(self.serial_button_frame, text='Disonnect Robot', command=self.do_disconnect_serial)
